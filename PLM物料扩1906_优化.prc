create or replace procedure proc_expand_1906_yh(v_pbompkgid varchar2,v_operator nvarchar2)
as
...
begin
       ...
       ( select id from (select max(t1.id) id, t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz
             ...
             where t.werks='1002' and t.beskz='E' and t.sbdkz='1' and t.no in  ---筛选条件一
             (select pno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by pno
               union
               select cno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by cno
              )
      ...
      -- dbms_output.put_line('扩展顺序一 ：'||to_char(sysdate,'yyyy-mm-dd hh24:mi:ss'));
       ...
       zmaktx, zsize, ztype, zcolor, zbranch, zauth, zrohs, zpackage, zpaper, zversion, zmanual, mstae,
       mtpos, v_werks, classnum, classtype, numerator, denominatr, bstme, xchpf, kordb, ekgrp, ztdline1, vkorg, vtweg, ktgrm, aland,
       tatyp, taxkm, mtpos1, tragr, ladgr, ztdline2, dismm, dispo, disls, null as bstrf, null as bstmi, v_berid, v_dispr, v_beskz,null as sobsl, rgekm, lgfsb,
       lgpro, dzeit, plifz, webaz, fhori, eisbe, perkz, strgr, vrmod, vint1, vint2, miskz, mtvfp, kzaus, nfmat, v_sbdkz, fevor, co_prodprf,
       mhdrz, mhdhb, loggr, lgnum, ltkze, qmatv, qpart, qmata, ssqss, ztdline3, bklas, eklas, qklas, mlast, peinh, vprsv, losgr, awsls, hrkft,
       prctr, ekalr, hkmat, sobsk, zplp3, zpld3, sipm91id, sipm94id, sipm95id, sipm96id, sipm97id, sipm98id, ztime1, zdate, ztime2, zmsgtp2,
       zmestx, prfrq, ausch,2,werks
       ...
       ( select id from (select max(t1.id) id, t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz
                           from  TEMP_WK_MATLIB t1
                                    where t1.werks in ('1002','1901')
                                    group by t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz) t
             where t.werks='1002' and t.beskz='F' and t.sbdkz='1'  and t.sobsl is null and t.no in ---筛选条件二
             (select pno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by pno
               union
               select cno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by cno
              )
       ...
       ( select id from (select max(t1.id) id, t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz
                           from  TEMP_WK_MATLIB t1
                                    where t1.werks in ('1002','1901')
                                    group by t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz) t
             where t.werks='1002' and t.beskz='E' and t.sbdkz='2'  and t.sobsl is null and t.no in ---筛选条件三
             (select pno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by pno
               union
               select cno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by cno
              )
       ...
       ( select id from (select max(t1.id) id, t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz
                           from  TEMP_WK_MATLIB t1
                                    where t1.werks in ('1002','1901')
                                    group by t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz) t
             where t.werks='1002' and t.beskz='E' and t.sbdkz='2'  and t.sobsl='50'  ---筛选条件四
             and t.no in
             (select pno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by pno
               union
               select cno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by cno
      ...
      -- dbms_output.put_line('扩展顺序四 ：'||to_char(sysdate,'yyyy-mm-dd hh24:mi:ss'));
       ...
       ( select id from (select max(t1.id) id, t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz
                           from  TEMP_WK_MATLIB t1
                                    where t1.werks in ('1002','1901')
                                    group by t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz) t
             where t.werks='1002' and t.beskz='F' and t.sbdkz='2' and t.sobsl = 'Z4'---筛选条件五
             and t.no in
             (select pno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by pno
               union
               select cno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by cno
       ...
       ( select id from (select max(t1.id) id, t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz
                           from  TEMP_WK_MATLIB t1
                                    where t1.werks in ('1002','1901')
                                    group by t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz) t
             where t.werks='1901' and t.beskz='F' and t.sbdkz='2' ---筛选条件六
             and t.no in
             (select pno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by pno
               union
               select cno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by cno
       ...
       ( select id from (select max(t1.id) id, t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz
                           from  TEMP_WK_MATLIB t1
                                    where t1.werks in ('1002','1901')
                                    group by t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz) t
             where t.werks='1002' and t.beskz='F' and t.sbdkz='2' and t.sobsl is null---筛选条件七
             and t.no in
             (select pno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by pno
               union
               select cno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by cno
       ...
       ( select id from (select max(t1.id) id, t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz
                           from  TEMP_WK_MATLIB t1
                                    where t1.werks in ('1002','1901')
                                    group by t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz) t
             where t.werks='1002' and t.beskz='F' and t.sbdkz='2' and t.sobsl='Z2'---筛选条件八
             and t.no in
             (select pno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by pno
               union
               select cno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by cno
       ...
       ( select id from (select max(t1.id) id, t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz
                           from  TEMP_WK_MATLIB t1
                                    where t1.werks in ('1002','1901')
                                    group by t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz) t
             where t.werks='1002' and t.beskz='F' and t.sbdkz='2' and t.sobsl='Z8'---筛选条件九
             and t.no in
             (select pno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by pno
               union
               select cno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by cno
      ...
      -- dbms_output.put_line('扩展顺序九 ：'||to_char(sysdate,'yyyy-mm-dd hh24:mi:ss'));
       ...
       ( select id from (select max(t1.id) id, t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz
                           from  TEMP_WK_MATLIB t1
                                    where t1.werks in ('1002','1901')
                                    group by t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz) t
             where (t.no like 'SW%' or t.no like 'V%') and t.werks='1002'---筛选条件十
             and t.no in
             (select pno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by pno
               union
               select cno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by cno
   ...
   ------------------------
       ...
       ( select id from (select max(t1.id) id, t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz
                           from  TEMP_WK_MATLIB t1
                                    where t1.werks in ('1002','1901')
                                    group by t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz) t
             where t.werks='1002' and t.beskz='X' and t.sbdkz='2' and t.sobsl is null---筛选条件十一
             and t.no in
             (select pno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by pno
               union
               select cno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by cno
       ...
       ( select id from (select max(t1.id) id, t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz
                           from  TEMP_WK_MATLIB t1
                                    where t1.werks in ('1002','1901')
                                    group by t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz) t
             where t.werks='1002' and t.beskz='F' and t.sbdkz='1' and t.sobsl='30'---筛选条件十二
             and t.no in
             (select pno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by pno
               union
               select cno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by cno
      ...
      -- dbms_output.put_line('扩展顺序十二 ：'||to_char(sysdate,'yyyy-mm-dd hh24:mi:ss'));
       ...
       ( select id from (select max(t1.id) id, t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz
                           from  TEMP_WK_MATLIB t1
                                    where t1.werks in ('1002','1901')
                                    group by t1.no, t1.werks, t1.beskz, t1.sobsl,t1.sbdkz) t
             where t.werks='1002' and t.beskz='F' and t.sbdkz='2' and t.sobsl='30'---筛选条件十三
             and t.no in
             (select pno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by pno
               union
              select cno as matnr from pbomlib where pbompkgid=v_pbompkgid and werks in ('1002','1901') group by cno
