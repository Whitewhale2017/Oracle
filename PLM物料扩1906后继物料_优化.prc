create or replace procedure proc_expand_nf_1906_yh(v_pbompkgid varchar2,v_operator nvarchar2)--扩展后继物料
as
...
begin
       ...
       ( select id from (
         ...
         where t.werks='1002' and t.beskz='E' and t.sbdkz='1'  ---筛选条件一
          and t.no in 
             (
              select NFMAT from SIPM170 where pbompkgid=v_pbompkgid and nfwerks in ('1002','1901') group by NFMAT
              )
       ...
       ( select id from (
         ...
         where t.werks='1002' and t.beskz='F' and t.sbdkz='1' and t.sobsl is null ---筛选条件二
              and t.no in  
             (
              select NFMAT from SIPM170 where pbompkgid=v_pbompkgid and nfwerks in ('1002','1901') group by NFMAT
              )
       ...
       ( select id from (
         ...
         where t.werks='1002' and t.beskz='E' and t.sbdkz='2' and t.sobsl is null  ---筛选条件三
              and t.no in 
             (
              select NFMAT from SIPM170 where pbompkgid=v_pbompkgid and nfwerks in ('1002','1901') group by NFMAT
              )
