select t1.requestid,
       ...
       t1.createdate,
       t1.createtime,
      (select HRMRESOURCE.lastname from  hrmresource where id=t1.creater) as creater,
       t1.creatertype,
       t1.workflowid,
       t1.requestname,
       t1.requestnamenew,
 ...
 where (t1.deleted <> 1 or t1.deleted is null or t1.deleted = '')
   ...
   and t1.workflowid in
       (select id from workflow_base where (WORKFLOW_BASE.isvalid = '1' or WORKFLOW_BASE.isvalid = '3'))
