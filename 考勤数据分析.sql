...
select * from HRMANNUALMANAGEMENT where RESOURCEID in (78,226,144) and ANNUALYEAR = 2018;--年假
...
select id,lastname,workcode,SUBCOMPANYID1 from HRMRESOURCE where lastname like '刘智%';